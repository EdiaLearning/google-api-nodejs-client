...
export namespace classroom_v1 {
   ...
   */
  export interface Schema$CheckAddOnCreationEligibilityResponse {
    /**
     * Immutable. Identifier of the course.
     */
    courseId?: string | null;
     ...
     */
    isCreateAttachmentEligible?: boolean | null;
  }
  /**
  ...
  export class Resource$Courses {
    ...
    /**
     * Returns whether a user is eligible to create add-on attachments in a given course. This method returns the following error codes: * `PERMISSION_DENIED` if the requesting user is not permitted to access the requested course or for access errors. * `INVALID_ARGUMENT` if the request is malformed. * `NOT_FOUND` if the requested course does not exist.
     *
    ...
    checkAddOnCreationEligibility(
      params: Params$Resource$Courses$Checkaddoncreationeligibility,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    checkAddOnCreationEligibility(
      params?: Params$Resource$Courses$Checkaddoncreationeligibility,
      options?: MethodOptions
    ): GaxiosPromise<Schema$CheckAddOnCreationEligibilityResponse>;
    checkAddOnCreationEligibility(
      params: Params$Resource$Courses$Checkaddoncreationeligibility,
    ...
    checkAddOnCreationEligibility(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$CheckAddOnCreationEligibilityResponse>,
      callback: BodyResponseCallback<Schema$CheckAddOnCreationEligibilityResponse>
    ): void;
    checkAddOnCreationEligibility(
      params: Params$Resource$Courses$Checkaddoncreationeligibility,
      callback: BodyResponseCallback<Schema$CheckAddOnCreationEligibilityResponse>
    ...
    checkAddOnCreationEligibility(
      paramsOrCallback?:
        | Params$Resource$Courses$Checkaddoncreationeligibility
        | BodyResponseCallback<Schema$CheckAddOnCreationEligibilityResponse>
      ...
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Courses$Checkaddoncreationeligibility;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Courses$Checkaddoncreationeligibility;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1/courses/{courseId}:checkAddOnCreationEligibility'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
      ...
      if (callback) {
        createAPIRequest<Schema$CheckAddOnCreationEligibilityResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$CheckAddOnCreationEligibilityResponse>(
          parameters
        );
      }
    }
  ...
  export interface Params$Resource$Courses$Checkaddoncreationeligibility
